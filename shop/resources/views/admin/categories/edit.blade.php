            ...
            <form action="{{ route('admin.categories.update', $category) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="name_ar" name="name_ar" value="{{ old('name_ar', $category->name_ar) }}" 
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea id="description_ar" name="description_ar" rows="3" 
                                  ...
                                  placeholder="وصف الفئة" dir="rtl">{{ old('description_ar', $category->description_ar) }}</textarea>
                    ...
                    <div class="md:col-span-2">
                        ...
                        @if($category->image_path)
                            <div class="mb-4">
                                <img src="{{ asset('storage/' . $category->image_path) }}" alt="{{ $category->name }}" class="h-32 w-32 rounded-lg object-cover">
